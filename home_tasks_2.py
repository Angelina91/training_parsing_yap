...
prices = soup.find_all(class_="price")  # Находим все теги с классом "price"
total_price = 0  # Общая стоимость элементов экипировки
count = 0  # Количество элементов экипировки

for price in prices[1:]:
    price_value = int(price.text)  # Получаем числовое значение цены
    total_price += price_value
    count += 1

result = total_price / count  # Считаем среднюю цену
